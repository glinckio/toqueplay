export enum TeamsErrorCode {
  ...
  USER_NOT_FOUND_BY_CPF = 'USER_NOT_FOUND_BY_CPF',
  MEMBER_IDENTITY_REQUIRED = 'MEMBER_IDENTITY_REQUIRED',
...
export const TeamsErrorMessages: Record<TeamsErrorCode, string> = {
  ...
  [TeamsErrorCode.USER_NOT_FOUND_BY_CPF]: 'No user found with this CPF',
  [TeamsErrorCode.MEMBER_IDENTITY_REQUIRED]: 'Provide an email or a CPF to invite a member',
